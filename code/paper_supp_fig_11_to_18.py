...
def gradt_hist_subplots_panels_methods(params, scale_size='one'):
    """
    Plot the distribution of gradients for different time windows with a panel for each method.

    Parameters:
    - params (list): A list of parameter values.
    - scale_size (str): The scale size of the earthquake. Default is 'one'.
...
def gradt_hist_subplots_panels_windows(params):
    """
    Plot the distribution of gradients for different time windows with a panel for each window.

    Parameters:
    - params (list): A list of values for each parameter.
...
def gradt_hist_subplots_panels_comparable(params):
    """
    Plot the distribution of gradients for different time windows with a panel for windows of comparable length.
