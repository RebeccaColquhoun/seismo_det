...
for i in range(0, len(eq_with_data)):
    ...
    eq.calc_tpmax(window_length=WINDOW_LEN, filter_limits=[0.1,19])
    print('save object')
    if eq.data is not False:
        with open('/home/earthquakes1/homes/Rebecca/phd/data/2019_global_m3/'+eq_with_data[i]+'/eq_object_1s_bandpass_01_19_snr_20.pkl', 'wb') as picklefile:
