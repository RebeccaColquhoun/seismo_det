...
if hypo and not laptop:
    ...
    save_path = '/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/overlaps/scaled/hypocentral'
elif not hypo and not laptop:
    data_path = '/home/earthquakes1/homes/Rebecca/phd/data/results_database'
    save_path = '/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/overlaps/scaled/epicentral'
...
def test_overlap_subplots(params, scale_size='whole'):
    ...
    for i, p in enumerate(params):
        ...
        axs[row][col].set_xlabel(f'{param_name}')
        # , 1/2 s.d. {marker}, \n flip = {p[0][flip]:.4f}, \n
    ...
    fig.tight_layout()
    fig.savefig(f'{save_path}/{f}_nstations_{n_stations}_mindist_{min_dist}_overlap_{marker[:-1]}_scale_{scale_size}.png')
...
for f in filenames:
    ...
    for n_stations in [1]:  # range(0, 7):
        for min_dist in [0]:  # range(0, 100, 10):
            ...
            for scale in ['whole', 'two', 'three', 'ten']:
