...
print(np.max(df_results.iloc[0]['tpmax_r'][0:20]))
print(np.max(df_results.iloc[3]['tpmax_r'][0:20]))
print(np.max(df_results.iloc[7]['tpmax_r'][0:20]))
print(np.max(df_results.iloc[12]['tpmax_r'][0:20]))
print(np.max(df_results.iloc[0]['tc_r'][0:20]))
print(np.max(df_results.iloc[3]['tc_r'][0:20]))
print(np.max(df_results.iloc[7]['tc_r'][0:20]))
print(np.max(df_results.iloc[12]['tc_r'][0:20]))
print(np.max(df_results.iloc[0]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[3]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[7]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[12]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[0]['pgd_r'][0:20]))
print(np.max(df_results.iloc[3]['pgd_r'][0:20]))
print(np.max(df_results.iloc[7]['pgd_r'][0:20]))
print(np.max(df_results.iloc[12]['pgd_r'][0:20]))
