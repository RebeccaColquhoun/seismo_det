...
def plot_pgd(title, mag_lim, corr_df):
    ...
    return scipy.stats.spearmanr(x[mask],y[mask])[0]
    #081839
...
def plot_tc(title, mag_lim, list_mags, list_tpmax):
    params = []
    opacities = np.linspace(0.2,1,45)
    import matplotlib.pyplot as plt
    cs = ['midnightblue']
...
for f in filenames:
    ...
    for mag_lim in magnitudes:
        ...
        if len(set(list_mags)) > 1:
            tc_n_int.append(len(list_mags))
            tc_r_int.append(plot_tc(f, mag_lim, list_mags, list_tc))
        else:
            tc_n_int.append(0)
            tc_r_int.append(0)
...
plt.close('all')
#[predominant period, iv2, average period, pgd, delaytime]
colors = ['#7f58af', '#64c5eb', '#e84d8a', '#7fb646', '#feb326']
...
line_style = ['solid','solid','solid','dotted','dotted','dotted','dotted', 'dashed', 'dashed', 'dashed', 'dashed', 'dashed',(0, (5, 10)), (0, (5, 10)), (0, (5, 10)), (0, (5, 10)), (0, (5, 10))]

for row in [0,3,7,12]:#range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['iv2_r2_r'], label = df_results.iloc[row]['filename'], color = colors[1],linestyle = line_style[row])
...
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/iv2_r2_r_different_mag.pdf')
plt.close('all')
for row in [0,3,7,12]:#range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['pgd_r'], label = df_results.iloc[row]['filename'], color = colors[3],linestyle = line_style[row])
...
plt.xlabel('magnitude')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/pgd_r_different_mag.pdf')
plt.close('all')


for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['tpmax_r'], label = df_results.iloc[row]['filename'], color = colors[0],linestyle = line_style[row])
...
plt.title('tpmax')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/tpmax_r_different_mag.pdf')
plt.close('all')

for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['tc_r'], label = df_results.iloc[row]['filename'], color = colors[2],linestyle = line_style[row])
...
plt.title('tc')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/tc_r_different_mag.pdf')
plt.close('all')

for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['tpmax_n'], label = df_results.iloc[row]['filename'], color = colors[0],linestyle = line_style[row])
...
plt.yscale('log')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/tpmax_n_different_mag.pdf')
#plt.show()
plt.close('all')

for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['tc_n'], label = df_results.iloc[row]['filename'], color = colors[2],linestyle = line_style[row])
...
plt.yscale('log')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/tc_n_different_mag.pdf')
#plt.show()
plt.close('all')

for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['pgd_n'], label = df_results.iloc[row]['filename'], color = colors[0],linestyle = line_style[row])
...
plt.yscale('log')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/pgd_n_different_mag.pdf')
#plt.show()
plt.close('all')

for row in [0,3,7,12]: #range(0, len(df_results)):
    plt.plot(magnitudes, df_results.iloc[row]['iv2_r2_n'], label = df_results.iloc[row]['filename'], color = colors[0],linestyle = line_style[row])
...
plt.yscale('log')
fig.set_size_inches(18.5, 10.5)
plt.savefig('/home/earthquakes1/homes/Rebecca/phd/seismo_det/figures/spearman_r/iv2_n_different_mag.pdf')
#plt.show()
plt.close('all')

print(np.max(df_results.iloc[0]['tpmax_r'][0:20]))#0.4778630002330568
print(np.max(df_results.iloc[3]['tpmax_r'][0:20]))#0.41752643932463196
print(np.max(df_results.iloc[7]['tpmax_r'][0:20]))#0.4453743685102422
print(np.max(df_results.iloc[12]['tpmax_r'][0:20]))#0.4534578256858528
print(np.max(df_results.iloc[0]['tc_r'][0:20]))#0.5547267876498921
print(np.max(df_results.iloc[3]['tc_r'][0:20]))#0.32469171241993533
print(np.max(df_results.iloc[7]['tc_r'][0:20]))#0.457361397628377
print(np.max(df_results.iloc[12]['tc_r'][0:20]))#0.46181633663393723
print(np.max(df_results.iloc[0]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[3]['iv2_r2_r'][0:20]))
print(np.max(df_results.iloc[7]['iv2_r2_r'][0:20]))#0.6688038692658846
print(np.max(df_results.iloc[12]['iv2_r2_r'][0:20]))#0.7581258003261357
print(np.max(df_results.iloc[0]['pgd_r'][0:20]))#0.6047804522466557
print(np.max(df_results.iloc[3]['pgd_r'][0:20]))#0.705338668449282
print(np.max(df_results.iloc[7]['pgd_r'][0:20]))#0.7830132418456476
print(np.max(df_results.iloc[12]['pgd_r'][0:20]))#0.8347131272716374
