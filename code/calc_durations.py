...
def calc_durations_range(list_moments = None, list_mags = None):
    if list_moments == None and list_mags == None:
        raise Exception("Need to specify moment or magnitude list")
...
def calc_single_duration(V, stressdrop, w_max, list_of_moments=None, list_of_mags=None):
    logT = []
    if list_moments == None and list_mags == None:
        raise Exception("Need to specify moment or magnitude list")
    elif list_moments == None:
