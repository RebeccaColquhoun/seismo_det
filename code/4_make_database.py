...
for fn in filenames:
	...
	if not os.path.exists(paths.data_path + '/results_database_combined_azimuths_reviews/'):
		os.makedirs(paths.data_path + '/results_database_combined_azimuths_reviews')
	df.to_pickle(paths.data_path + '/results_database_combined_azimuths_reviews/results_' + fn + '.pkl')
