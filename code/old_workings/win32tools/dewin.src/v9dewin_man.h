#ifndef V9DEWIIIN_MAN_HHHH
#define V9DEWIIIN_MAN_HHHH
...
int     buf[MAX_SR];
double  dbuf[MAX_SR];
unsigned int    au_header[8] = {0x2e736e64, 0x00000020, 0xffffffff, 0x00000001,
0x00001f40, 0x00000001, 0x00000000, 0x00000000};
int giKminutes;  /** 1:minutes file, 0:not minutes file **/
int giNsample;   /** sampling number (0>, <2000) **/
